...
class ColorManager {
  ...
  //PURPLE PALETTE
  static const Color purple0 =  Color(0xffe9e8f1);
  static const Color purple1 =  Color(0xffd3caf1);
  static const Color purple2 =  Color(0xffc9bce7);
  static const Color purple3 =  Color(0xffaa96da);
  static const Color purple4 =  Color(0xff8b70cd);
  static const Color purple5 =  Color(0xff6639A6);
  static const Color purple6 =  Color(0xff43256d);
