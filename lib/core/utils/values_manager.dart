...
class DurationConstant{
  ...
  static const kTransitionDuration1s = Duration(seconds: 1);
  static const kTransitionDuration2s = Duration(seconds: 2);
  static const kTransitionDuration800ms = Duration(milliseconds: 800);
  static const kTransitionDuration400ms = Duration(milliseconds: 400);
